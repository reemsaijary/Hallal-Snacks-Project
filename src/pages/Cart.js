...
const CheckoutModal = ({ show, onClose, cartItems, total, clearCart }) => {
  ...
  const handleWhatsAppOrder = (e) => {
    ...
    const phoneNumber = "96103675158"; // Your restaurant WhatsApp number
              ...
              {orderType === "Delivery" && (
                <div className="mb-3">
                  ...
                  <div className="form-text">
                    Please be specific to ensure fast delivery.
                  </div>
                </div>
              )}
            </div>
...
function Cart() {
  const { cartItems, updateItemQuantity, removeItemFromCart, clearCart, calculateTotal } =
    useCart();
                    ...
                    <tr key={item.name}>
                      ...
                      <td className="text-center quantity-control">
                        <div className="input-group input-group-sm justify-content-center">
                          ...
                          <span className="form-control text-center quantity-display">
                            {item.quantity}
                          </span>
                          <button
                            className="btn btn-outline-warning"
          ...
          <div className="col-lg-4">
            <div className="card order-summary-card p-4">
              ...
              <ul className="list-group list-group-flush">
                ...
                <li className="list-group-item d-flex justify-content-between align-items-center fw-bold text-warning">
                  Estimated Tax: <span>$0.00</span>
                </li>
                <li className="list-group-item d-flex justify-content-between align-items-center fw-bold fs-5 total-row">
                  Total: <span>${total.toFixed(2)}</span>
                </li>
              </ul>

              <button
                className="btn btn-success btn-lg mt-4 checkout-btn"
